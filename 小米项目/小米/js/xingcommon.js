 ...
 * @param dis       移动的距离
 */
xm.setTransform = function(obj, dis, dir){
 ...
 * @param obj       需要移除过度的对象
 */
xm.removeTransition = function(obj){
 ...
 * @param fn        调用的函数
 */
xm.addTransitionEnd = function(obj, fn){
